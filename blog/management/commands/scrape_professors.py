    ...
    def handle(self, *args, **kwargs):
        ...
        for row in rows:
            ...
            if len(data_elems) >= 4:
                ...
                prof_obj, created = Professor.objects.get_or_create(department=department_obj, name_prof=prof_name, profile_pic_url=None)
                ...
                for docencia_row in docencia_rows:
                    ...
                    subject_obj, created = Subject.objects.get_or_create(name_sub=subject_name, description=None, credits=6)
                ...
                if recerca_zone:
                    ...
                    if len(recerca_tables) >= 3:
                        ...
                        for publication_row in publication_rows:
                            ...
                            publication_obj, created = Publication.objects.get_or_create(title_pub=title_pub, publish_date=pub_year, url=None)
                            profpub_obj, created = Professor_Publication.objects.get_or_create(professor=prof_obj, publication=publication_obj, author_order=None)
